...
var _smoothScroll = __webpack_require__(330);

var _smoothScroll2 = _interopRequireDefault(_smoothScroll);

var _svg4everybody = __webpack_require__(331);

var _svg4everybody2 = _interopRequireDefault(_svg4everybody);

var _mobileDetect = __webpack_require__(125);
...
var _FixSection = __webpack_require__(338);
...
var app = {
  ...
  bindEvents: function bindEvents() {
    ...
    var sec9FormHandlers = new _Form2.default('.sec9__form');
    sec9FormHandlers.init();

    var popupFormHandlers = new _Form2.default('.index__form');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dom7_dist_dom7_modular__ = __webpack_require__(335);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ssr_window__ = __webpack_require__(126);
/**
 * Swiper 4.4.2
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ssr_window__ = __webpack_require__(126);
/**
 * Dom7 2.1.2
  ...
  _createClass(Form, [{
    ...
    value: function validateForm() {
      ...
      [].concat(_toConsumableArray(fields)).forEach(function (field) {
        if (field.classList.contains(_this.invalidClass) || !field.classList.contains(_this.validClass)) {
          valid.push(false);
        } else if (field.classList.contains(_this.validClass)) {
          valid.push(true);
        }
      });
