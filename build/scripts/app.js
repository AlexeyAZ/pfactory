...
var _smoothScroll = __webpack_require__(339);

var _smoothScroll2 = _interopRequireDefault(_smoothScroll);

var _svg4everybody = __webpack_require__(340);

var _svg4everybody2 = _interopRequireDefault(_svg4everybody);

var _mobileDetect = __webpack_require__(126);
...
var _FixSection = __webpack_require__(365);

var _FixSection2 = _interopRequireDefault(_FixSection);
...
var app = {
  ...
  bindEvents: function bindEvents() {
    ...
    var headerHandlers = new _Header2.default();
    headerHandlers.init();

    var advantagesSlider = new _slider2.default();
    ...
    var createScrollMagic = function createScrollMagic() {
      var fixSectionHandler = new _FixSection2.default();
      fixSectionHandler.init();

      var dummyBlock = fixSectionHandler.getDummyBlock();

      if (dummyBlock) {
        dummyBlock.on('progress', function (e) {
          if (e.progress === 1) {
    ...
    (0, _map2.default)(['.sec9__map_mobile', '.sec9__map_desktop']);
    ...
    if (!md.mobile() && !window.matchMedia('(max-width: 1024px)').matches) {
      ...
      var sec5SliderAnimation = function sec5SliderAnimation() {
        var activeSlideClass = 'sec5__slider-slide_active';
        var activeIndex = 0;
        var swiperGroupIndex = 1;
        var slidesPerView = sec5Slider.getSlider().params.slidesPerView;
        var sec5SliderEl = sec5Slider.getSlider().el;
        var sec5Slides = sec5SliderEl.querySelectorAll('.sec5__slider-slide');
        ...
        var clearActiveClass = function clearActiveClass() {
          sec5Slides.forEach(function (item) {
            if (item.classList.contains(activeSlideClass)) {
              item.classList.remove(activeSlideClass);
            }
          });
        };
        var toggleActiveIndex = function toggleActiveIndex(maxLength) {
        ...
        var toggleActiveSlide = function toggleActiveSlide() {
          clearActiveClass();
...
var _swiper = __webpack_require__(361);
...
var Slider = function () {
  ...
  _createClass(Slider, [{
    ...
    key: 'createSlider',
    value: function createSlider(_element, _options) {
      var options = Object.assign(this.options, _options);
      this.swiper = new _swiper2.default(_element, options);
    }
  }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dom7_dist_dom7_modular__ = __webpack_require__(362);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ssr_window__ = __webpack_require__(135);
/**
 * Swiper 4.4.2
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ssr_window__ = __webpack_require__(135);
/**
 * Dom7 2.1.2
...
function siteMaps(elements) {
  if (elements.length > 0) {
    elements.forEach(function (el) {
      var map = document.querySelector(el);
      if (map) {
  ...
  _createClass(Header, [{
    ...
    value: function setState() {
      if (window.matchMedia('(min-width: 768px)').matches) {
        ...
        var button = header.querySelector('.header__button');
...
var _scrollmagic = __webpack_require__(366);
...
var FixSection = function () {
  function FixSection() {
    _classCallCheck(this, FixSection);
  ...
  _createClass(FixSection, [{
    ...
    value: function init() {
      ...
      var fixSection = document.querySelector('.fix-section');
      var offset = fixSection.clientHeight - document.documentElement.clientHeight;
      var md = new _mobileDetect2.default(window.navigator.userAgent);
      ...
      if (!md.mobile()) {
        ...
        this.scene = new _scrollmagic2.default.Scene({
          offset: offset
        }).setPin(fixSection).addTo(controller);

        this.dummyBlock = new _scrollmagic2.default.Scene({ triggerElement: '.dummy', triggerHook: 0.8 }).setClassToggle('.advantages__slider', 'active').addTo(controller);
...
var Popup = function () {
  ...
  _createClass(Popup, [{
    ...
    value: function init() {
      ...
      var closeButton = this.element.querySelector('.popup__close');
...
var _imask = __webpack_require__(369);

var _imask2 = _interopRequireDefault(_imask);

var _rules = __webpack_require__(370);
...
var Form = function () {
  ...
  _createClass(Form, [{
    ...
    value: function resetForm() {
      ...
      var fields = this.form.querySelectorAll('.input__field');
      fields.forEach(function (field) {
        field.value = '';
        field.classList.remove(_this.validClass);
        field.classList.remove(_this.invalidClass);
      });
    ...
    key: 'makePhoneMask',
    value: function makePhoneMask() {
      var phoneFields = this.form.querySelectorAll('.input__field[name="phone"]');
      phoneFields.forEach(function (field) {
        var mask = (0, _imask2.default)(field, { mask: '+{0} (000) 000-00-00' });
    ...
    value: function showMessage(type) {
      ...
      var messages = this.form.querySelectorAll('.' + this.messageClass);
      var successMessage = this.form.querySelector('.' + this.successMessageClass);
      var errorMessage = this.form.querySelector('.' + this.errorMessageClass);
      if (type === 'error') {
      ...
      if (type === 'clear') {
        messages.forEach(function (message) {
          message.classList.remove(_this2.messageShowClass);
        });
      }
    }
  }, {
    ...
    value: function validateForm() {
      ...
      var fields = this.form.querySelectorAll('.input__field[required], .input__field[type="email"]');
      var valid = [];
      [].concat(_toConsumableArray(fields)).forEach(function (field) {
        if (field.classList.contains(_this3.invalidClass) || !field.classList.contains(_this3.validClass)) {
          valid.push(false);
        } else if (field.classList.contains(_this3.validClass)) {
          valid.push(true);
        }
      });

      this.valid = valid.every(function (element) {
        return element === true;
      });
    ...
    value: function validateField(field) {
      if (field.getAttribute('required') || field.getAttribute('type') === 'email') {
        ...
        if (field.getAttribute('required')) {
          validField = _rules2.default.required().validate(field.value);
        }
        if (field.getAttribute('type') === 'email') {
          validField = _rules2.default.email().validate(field.value);
        }
        if (validField) {
          this.setValid(field);
        } else {
...
var isEmail = function isEmail(value) {
  return EMAIL_REG_EX.test(String(value).toLowerCase());
};
